...
hl.bind("SUPER + bracketleft", function() hl.dispatch("resizeactive", "-100 0") end, { description = "Expand window left" })
hl.bind("SUPER + bracketright", function() hl.dispatch("resizeactive", "100 0") end, { description = "Shrink window left" })
hl.bind("SUPER + SHIFT + bracketleft", function() hl.dispatch("resizeactive", "0 -100") end, { description = "Shrink window up" })
hl.bind("SUPER + SHIFT + bracketright", function() hl.dispatch("resizeactive", "0 100") end, { description = "Expand window down" })

-- -- Switch and Move to workspaces (The Lua Way) --
